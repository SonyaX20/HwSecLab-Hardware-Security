...
def aes_key_expansion(key):
    ...
    expanded_key_total = [word for sublist in key_words for word in sublist]
    expanded_key = [expanded_key_total[i:i+16] for i in range(0,len(expanded_key_total),16)]
    return expanded_key
